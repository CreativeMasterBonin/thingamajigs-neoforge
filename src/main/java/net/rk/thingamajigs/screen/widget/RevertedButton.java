...
public class RevertedButton extends ExtendedButton{
    ...
    public static final WidgetSprites LASER_SPRITES = new WidgetSprites(
            ResourceLocation.parse("thingamajigs:container/laser_light/pressed_button"),
            ResourceLocation.parse("thingamajigs:container/laser_light/disabled_button"),
            ResourceLocation.parse("thingamajigs:container/laser_light/selected_button")
    );
