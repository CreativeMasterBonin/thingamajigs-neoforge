...
public class Chair extends Entity {
    public Chair(EntityType<?> et, Level lvl) {
        super(TEntity.CHAIR.get(), lvl);
        this.noPhysics = true;
    }

    public Chair(Level lvl, BlockPos pos, Direction dir) {
        this(TEntity.CHAIR.get(),lvl);
    ...
    public Component getName() {
        return Component.literal("chair_entity");
    }
}
