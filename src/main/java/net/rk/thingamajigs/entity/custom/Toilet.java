...
public class Toilet extends Entity {
    public Toilet(EntityType<?> et, Level lvl) {
        super(TEntity.TOILET.get(), lvl);
        this.noPhysics = true;
    }

    public Toilet(Level lvl, BlockPos pos, Direction dir) {
        this(TEntity.TOILET.get(),lvl);
    ...
    public Component getName() {
        return Component.literal("toilet_entity");
    }
}
